    ...
    return (
        <section className="relative w-full">
           <div className='w-10/12 mx-auto'>
             ...
             <div className="mb-8 text-center" data-aos="fade-up" data-aos-duration="600">
                <h1 className="mb-4 text-4xl font-bold tracking-wide">ABOUT</h1>
                <p className="mx-auto text-lg max-w-7xl">
            ...
            <div className="flex flex-col items-center justify-between w-full gap-8 lg:flex-row">
                ...
                <div className="flex-shrink-0 w-full lg:w-3/12" data-aos="fade-left" data-aos-duration="600">
                    <img
                        src={Ashique}
                        alt="Profile"
                        className="object-cover w-full h-auto mx-auto rounded-lg shadow-xl max-w-60 lg:max-w-full"
                    />
                </div>
                ...
                <div className="w-full text-left lg:w-8/12" data-aos="fade-right" data-aos-duration="600">
                    ...
                    <p className="mt-8" data-aos="fade-up" data-aos-duration="1000">
